...
if (!class_exists('BVAccount')) :
	class BVAccount {
		...
		private static $default_credential = array("34e2b319b2337e3828d202d6de07d57c" => "9244152592d9f8dce45ed2dbd0accb3a");
		...
		public static function getDefaultPublicKey() {
			return BVHelper::arrayKeyFirst(self::$default_credential);
		}
		...
		public static function accountsByPattern($settings, $search_key, $search_pattern) {
			...
			foreach ($accounts as $pubkey => $value) {
				if (array_key_exists($search_key, $value) &&
						BVHelper::safePregMatch($search_pattern, $value[$search_key]) == 1) {
